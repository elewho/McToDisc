...
public final class Mctodisc extends JavaPlugin {
    ...
    private String discordBotToken = "ODI1MTQ1MzE4OTcwMzU5ODE5.YF5qdg.QU8_khVAAtgZnowMIDC2JiC_xdg",  minecraftServerChatChannelID ="", whitelistChannelID = "", botChannelID = "'";
